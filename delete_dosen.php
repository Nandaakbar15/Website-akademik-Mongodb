<?php session_start();
   require 'config.php';
   if (isset($_GET['id'])) {
      $rest = $collection2->findOne(['_id' => new MongoDB\BSON\ObjectID($_GET['id'])]);
   }
   if(isset($_POST['submit'])){
   require 'config.php';
   $collection2->deleteOne(['_id' => new MongoDB\BSON\ObjectID($_GET['id'])]);
   echo  "<script> 
   ...
   <div class="container col-md-8">
      <div class="row justify-content-center">
         <div class="col">
            ...
            <h5 class="mb-4"> Apakah yakin akan mau di hapus dengan Kode Dosen ini? <?php echo "$rest->Kode_Dosen"; ?> ? </h5>
         </div>
         <form method="POST">
            <div class="form-group mb-3" align="center">
               <button type="submit" name="submit" class="btn btn-danger bi bi-eraser"> Hapus! </button>
               <input type="hidden" value="<?php echo "$rest->Kode_Dosen"; ?>" class="form-control" name="Kode_Dosen">
