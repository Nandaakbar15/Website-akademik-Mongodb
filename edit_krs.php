                        ...
                        <form method="POST">
                            <ul>
                                <li style="list-style: none;">
                                    ...
                                    <input type="text" class="form-control" name="NIM" value="<?php echo "$krs->NIM;"?>" required>
                                </li>
                                <li style="list-style: none;">
                                    <label for="Kode_MK">Nama: </label>
                                    <input type="text" class="form-control" name="Kode_MK" value="<?php echo "$krs->Kode_MK;"?>"  required>
                                </li>
                                <li style="list-style: none;">
                                    <label for="Semester">Prodi: </label>
                                    <input type="text" class="form-control" name="Semester" value="<?php echo "$krs->Semester;"?>"  required>
                                </li>
                                <li style="list-style: none;">
