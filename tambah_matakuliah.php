                        ...
                        <form method="POST">
                            <ul>
                                <li style="list-style: none;">
                                    ...
                                    <input type="text" class="form-control" value="Kode_Kuliah" name="Kode_Kuliah" required>
                                </li>
                                <li style="list-style: none;">
                                    <label for="Matakuliah">Matakuliah: </label>
                                    <input type="text" class="form-control" value="Matakuliah" name="Matakuliah" required>
                                </li>
                                <li style="list-style: none;">
                                    <label for="SKS">SKS: </label>
                                    <input type="text" class="form-control" value="SKS" name="SKS" required>
                                </li>
                                <li style="list-style: none;">
                                    <label for="Kode_Dosen">Kode_Dosen: </label>
