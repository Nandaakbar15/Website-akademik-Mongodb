                        ...
                        <form method="POST">
                            <ul>
                                <li style="list-style: none;">
                                    ...
                                    <input type="text" class="form-control" value="NIM" name="NIM" required>
                                </li>
                                <li style="list-style: none;">
                                    <label for="Kode_MK">Kode MK: </label>
                                    <input type="text" class="form-control" value="Kode_MK" name="Kode_MK" required>
                                </li>
                                <li style="list-style: none;">
                                    <label for="Semester">Semester: </label>
                                    <input type="text" class="form-control" value="Semester" name="Semester" required>
                                </li>
                                <li style="list-style: none;">
